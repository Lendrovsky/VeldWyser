...
export const metadata = getSEOTags({
  title: `${config.appName} News | Stripe Chargeback Protection`,
  description:
    ...
    <>
      <section className="text-center max-w-xl mx-auto mt-12 mb-24 md:mb-32">
        <h1 className="font-extrabold text-3xl lg:text-5xl tracking-tight mb-6">
          {config.appName} News & Updates
        </h1>
        <p className="text-lg opacity-80 leading-relaxed">
          Stay up to date with our latest updates and developments by following us on social media or read the articles below.
          </p>
      </section>
